...
sizeof(sd001),0x03,
{'D', 'e', 'k', 'i', 's', 't', ' ', 'C', 'o', '.', ',', ' ', 'L', 't', 'd', '.','\0'}
};


struct{uint8_t bLength;uint8_t bDscType;uint16_t string[25];}sd002={
sizeof(sd002),0x03,
{'U','A','_','S','E','R','I','E','S','_', '_', 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,'\0'}
};
