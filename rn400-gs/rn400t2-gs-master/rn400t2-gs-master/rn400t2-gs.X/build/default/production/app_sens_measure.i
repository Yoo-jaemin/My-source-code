...
# 20 "app_sens_measure.c"
extern s_Nvm g_nvm;

extern u_SensorValue g_modbus_value;
float g_last_value[2][LV_TEMP+1];
float g_temp_value[LV_TEMP+1];
...
s_EwmaFilter_t ewmaFilter[2];



s_KalmanFilter_t kalmanFilter[2];
...
ewmaFilter[0].hasInit = 0;
ewmaFilter[0].prevValue = 0.0f;
ewmaFilter[1].hasInit = 0;
...
g_sens_measure.existChannel[i] = 0;
g_sens_measure.isChecksum[i] = 0;
g_sens_measure.isSensorInit[i] = 0;
g_last_value[i][LV_TEMP] = -999995.0f;
g_last_value[i][LV_GAS_VOLT] = -999995.0f;
g_last_value[i][LV_GAS_PPM] = -999995.0f;
}
...
g_sens_measure.existChannel[g_channel_no] = 0;
g_sens_measure.isChecksum[g_channel_no] = 0;
g_sens_measure.isSensorInit[g_channel_no] = 0;
...
if (ret == 1) {
g_sens_measure.existChannel[g_channel_no] = 1;
if (g_nvm.eeprm[g_channel_no].check_sum == checksum(g_nvm.eeprm[g_channel_no].byte, 62-2)) {
g_sens_measure.isChecksum[g_channel_no] = 1;
...
if (g_sens_measure.existChannel[g_channel_no] == 1 &&
g_sens_measure.isChecksum[g_channel_no] == 1) {
...
if (ret == 1) {
g_sens_measure.isSensorInit[g_channel_no] = 1;
g_retry_count = 0;
g_large_counter = 0;
...
case SENS_READY:
if (USBDeviceState == CONFIGURED_STATE || g_nvm.flash.sensing_on == SENSING_ON) {

# 320
if (g_large_counter >= 500) {
g_large_counter = 0;
...
g_last_value[g_channel_no][LV_TEMP] = g_last_value[g_channel_no][LV_GAS_VOLT] = -999995.0f;
g_modbus_value.float_value[g_channel_no] = g_last_value[g_channel_no][LV_GAS_PPM] = -999995.0f;
}
g_large_counter = 0;
g_sens_measure.seq = SENS_NEXT;
break;
