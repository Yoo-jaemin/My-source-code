...
# 1 "lightmodbus/master/mpcoils.c"
...
# 49 "lightmodbus/master/../lightmodbus.h"
...
# 43 "lightmodbus/master/../parser.h"
...
# 47 "lightmodbus/master/../master/mbcoils.h"
...
# 240 "lightmodbus/master/../master.h"
...
if ( status == (0) || parser == (0) || requestParser == (0) ) return MODBUS_ERROR_NULLPTR;
if ( parser->_base.function != 1 && parser->_base.function != 2 )
{
...
if ( parser->_base.address != requestParser->_base.address )
{
status->parseError = MODBUS_FERROR_MISM_ADDR;
return MODBUS_ERROR_PARSE;
}

if ( parser->_base.function != requestParser->_base.function )
{
...
# 88
if ( modbusBitsToBytes( count ) * sizeof( uint8_t ) > 3 ) return MODBUS_ERROR_ALLOC;
...
status->data.function = parser->_base.function;
status->data.address = parser->_base.address;
status->data.type = parser->_base.function == 1 ? MODBUS_COIL : MODBUS_DISCRETE_INPUT;
...
# 169
if ( 1 * sizeof( uint8_t ) > 3 ) return MODBUS_ERROR_ALLOC;
