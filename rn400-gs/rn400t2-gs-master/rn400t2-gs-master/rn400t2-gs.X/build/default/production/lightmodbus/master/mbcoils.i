...
# 1 "lightmodbus/master/mbcoils.c"
...
# 29 "lightmodbus/master/mbcoils.c"
...
# 68
if ( frameLength > 9 ) return MODBUS_ERROR_ALLOC;
memset( status->request.frame, 0, frameLength );


ModbusParser *builder = (ModbusParser *) status->request.frame;

builder->_base.address = address;
builder->_base.function = function;
