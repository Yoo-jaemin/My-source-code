...
#pragma config WDTPS = 1024        //1:1,024 (2.7 seconds)
#pragma config DSWDTOSC = INTOSCREF //DSWDT uses INTOSC/INTRC as clock
#pragma config RTCOSC = T1OSCREF    //RTCC uses T1OSC/T1CKI as clock
#pragma config DSBOREN = OFF        //Zero-Power BOR disabled in Deep Sleep
//#pragma config DSBOREN = ON        //Zero-Power BOR disabled in Deep Sleep
#pragma config DSWDTEN = OFF        //Disabled
//#pragma config DSWDTEN = ON        //Disabled
//#pragma config DSWDTPS = 8192       //1:8,192 (8.5 seconds)
#pragma config DSWDTPS = 2048       //1:2,048 (2.1 seconds)
//#pragma config IOL1WAY = OFF        //IOLOCK bit can be set and cleared
#pragma config IOL1WAY = ON        //IOLOCK bit can be set and cleared
#pragma config MSSP7B_EN = MSK7     //7 Bit address masking
#pragma config WPFP = PAGE_1        //Write Protect Program Flash Page 0
//#pragma config WPFP = PAGE_0        //Write Protect Program Flash Page 0
//#pragma config WPEND = PAGE_0       //Start protection at page 0
//#pragma config WPEND = PAGE_WPFP       //Start protection at page 0
...
extern volatile uint16_t g_large_counter;
#ifdef USE_CHECK_CHANNEL_PERIODIC
extern volatile uint32_t g_sensor_counter;
#endif
extern volatile uint32_t g_usedtime_count;
extern volatile uint8_t g_timeout_count;
extern volatile uint16_t g_relay_sec_count;
extern volatile uint16_t g_relay_status_count;
