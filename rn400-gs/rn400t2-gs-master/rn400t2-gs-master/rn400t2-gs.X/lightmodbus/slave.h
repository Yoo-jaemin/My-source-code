...
*/
// nakholee modified
extern ModbusError modbusBuildExceptionErr( ModbusSlave *status, uint8_t function, ModbusExceptionCode code, ModbusFrameError parseError ); //Build an exception and write error to status->parseError
