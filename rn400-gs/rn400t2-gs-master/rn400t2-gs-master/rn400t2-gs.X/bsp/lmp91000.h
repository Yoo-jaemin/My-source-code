...
//    bool lmp91000_set_InternalGain(uint8_t* preg, uint8_t user_gain);
//    bool lmp91000_set_RLoad(uint8_t* preg, uint8_t RLoad);
//    
//    bool lmp91000_set_RefSource(uint8_t* preg, uint8_t source);
//    bool lmp91000_set_IntZero(uint8_t* preg, uint8_t IntZ);
//    bool lmp91000_set_BiasSign(uint8_t* preg, uint8_t sign);
//    bool lmp91000_set_Bias(uint8_t* preg, uint8_t bias);
//    
//    bool lmp91000_set_FET(uint8_t* preg, uint8_t fet);
//    bool lmp91000_set_OperatingMode(uint8_t* preg, uint8_t mode);
