...
if (g_led_counter > 50) {
LED_Off();
LED_On((g_led_status.toggle==1)?LED_RED:LED_GREEN);
g_led_status.toggle = (g_led_status.toggle)?0:1;
g_led_counter = 0;
}
}
...
if (g_led_counter > 10) {
g_led_counter = 0;
if (g_led_status.toggle == 1) {
LED_Off();
g_led_status.toggle = 0;
} else {
LED_On(LED_GREEN);
g_led_status.toggle = 1;
}
}
}
...
case LED_COMMAND:
LED_Off();
LED_On((g_led_status.twoYear==1)?LED_RED:LED_GREEN);
g_led_counter = 0;
g_led_status.seq = LED_NOTHING;
break;
case LED_ZEROCAL:
