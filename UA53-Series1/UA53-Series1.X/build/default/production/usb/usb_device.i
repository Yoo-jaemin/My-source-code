...
# 141
 ...
 uint8_t USBAlternateInterface[2];
...
volatile BDT_ENTRY *pBDTEntryIn[2+1];
 ...
 uint8_t *pDst;
 bool RemoteWakeup;
 bool USBBusIsSuspended;
 USTAT_FIELDS USTATcopy;
 uint8_t endpoint_number;
 bool BothEP0OutUOWNsSet;
 EP_STATUS ep_data_in[2+1];
 EP_STATUS ep_data_out[2+1];
...
# 174
volatile BDT_ENTRY BDT[((2 + 1) * 4)] __at(0x400);

# 179
volatile CTRL_TRF_SETUP SetupPkt __at((0x400+(((2 + 1) * 4)*4)));
volatile uint8_t CtrlTrfData[8] __at(((0x400+(((2 + 1) * 4)*4)) + 8));
