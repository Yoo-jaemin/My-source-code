...
{
return ads1114_SetUp(CONTINUE_CONV, FSR_0p256V, SPS128);
}
...
if (lmp91000_set_GainRLoad(R350K, R10) == 0)
return 0;



if (lmp91000_set_Reference(EXTERNAL, S20P, NAGATIVE, B0P) == 0)
return 0;
...
bool sensor_init(void)
{
if (sensor_sht3x_init() == 0)
return 0;

if (sensor_lmp_init() == 0)
return 0;

if (sensor_adc_init() == 0)
return 0;
...
g_uV_per_ppm = sensitivity * 350.0f;



float nA = ((gas_uVolt + g_nvm.flash.zeroShift_uV) - (baseline + g_nvm.flash.zeroShift_uV)) / 350.0f;
