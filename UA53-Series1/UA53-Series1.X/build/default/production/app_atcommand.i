...
extern float g_temp_value[LV_HUMI+1];
...
if (g_led_status.isBlink == 0 && g_sens_autoCalib.led_slpSet == OFF)
...
case ATCVER: len += _strcpy(&writeBuffer[len], "UA53-O3""_""6v1"); break;
case ATCUV:
{
for (i = 0 ; i < 2 ; i++) {
