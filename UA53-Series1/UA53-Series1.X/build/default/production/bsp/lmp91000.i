...
if (i2c_writeBytes(0x90, &wBuff, 1, 0) == 0) {
return 0;
}

if (i2c_readBytes(0x90, &rBuff, 1) == 0) {
return 0;
}
...
return i2c_writeBytes(0x90, buff, 2, 1);
}
...
if (lmp91000_get_status(&rBuff) == 0)
return 0;
