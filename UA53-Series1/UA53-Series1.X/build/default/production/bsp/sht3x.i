...
cmd[0] = 0x30;
cmd[1] = 0xa2;
return i2c_writeBytes(0x88, cmd, 2, 1);
}
...
{
uint8_t buff[6];
if (i2c_readBytes(0x88, buff, 6) == 0)
return 0;

if(check_crc8(&buff[0], 2, buff[2]) == 0)
return 0;
if(check_crc8(&buff[3], 2, buff[5]) == 0)
return 0;
...
if (sht3x_common_read(&raw_temp, &raw_humi) == 0)
return 0;
...
if (i2c_writeBytes(0x88, cmd, 2, 0) == 0)
return 0;

if (sht3x_measure_read(temp, humi) == 0)
return 0;
...
if (i2c_writeBytes(0x88, cmd, 2, 1) == 0)
return 0;

_delay((unsigned long)((15000)*(48000000/4000000.0)));
...
if (i2c_readBytes_from(0x88, cmd, 2, buff, 3) == 0)
return 0;
...
if (i2c_writeBytes_to(0x88, cmd, 2, buff, 3) == 0)
return 0;
